...
export default function Hero() {
  return (
    <section className="min-h-screen flex flex-col md:flex-row items-center justify-center px-8">
      {/* Left Content */}
      <div className="text-left max-w-2xl">
        ...
        <motion.h2
          ...
          className="text-3xl md:text-5xl font-bold mb-6 leading-relaxed text-white"
        >
...
>
      ...
      >
        {/* Violet Glow */}
        <div className="absolute inset-0 rounded-full bg-violet-600 opacity-50 blur-3xl scale-125"></div>

        {/* Avatar */}
        <div className="relative w-48 h-48 md:w-64 md:h-64 rounded-full overflow-hidden border-4 border-violet-500 shadow-lg">
          <Image
            src="/avatar.png" // Make sure avatar.png is in the public folder
            alt="Ashik Kishor"
            width={256}
            height={256}
